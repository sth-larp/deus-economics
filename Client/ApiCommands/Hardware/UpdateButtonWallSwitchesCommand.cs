...
namespace WispCloudClient.ApiCommands
{
    public sealed class UpdateButtonWallSwitchesCommand : InputCommand<List<ButtonWallSwitchStatusClientData>>
    {
        ...
        {
            return new[] {
                new ButtonWallSwitchStatusClientData() { ButtonWallSwitchSN = "1", Battery = 50 },
                new ButtonWallSwitchStatusClientData() { ButtonWallSwitchSN = "2", Battery = 50 },
            };
        }
        ...
        protected override object GenerateBodyRequest()
        {
            ...
            for (int i = 0; i < StaticRandom.Next(2) + 2; i++)
                ...
                { ButtonWallSwitchSN = (i + 1).ToString(), Battery = StaticRandom.Next(100) });
